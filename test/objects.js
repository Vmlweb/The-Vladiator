...
describe('Objects', function() {
	...
	it('should pass when object contains key and boolean value', function () {
		...
		var test = validate(obj).hasKeyValue('test3', true);
		var test2 = validate(obj).missingKeyValue('test3', true);
		var expected = true;
	...
	it('should pass when object contains key and number value', function () {
		...
		var test = validate(obj).hasKeyValue('test2', 5);
		var test2 = validate(obj).missingKeyValue('test2', 5);
		var expected = true;
	...
	it('should pass when object contains key and string value', function () {
		...
		var test = validate(obj).hasKeyValue('test', 'hello2');
		var test2 = validate(obj).missingKeyValue('test', 'hello2');
		var expected = true;
	...
	it('should fail when object contains value but not key', function () {
		...
		var test = validate(obj).hasKeyValue('test4', 'hello2');
		var test2 = validate(obj).missingKeyValue('test4', 'hello2');
		var expected = false;
	...
	it('should fail when object contains key but not value', function () {
		...
		var test = validate(obj).hasKeyValue('test2', 10);
		var test2 = validate(obj).missingKeyValue('test2', 10);
		var expected = false;
	...
	it('should fail when object does not contain key or value', function () {
		...
		var test = validate(obj).hasKeyValue('test4', 10);
		var test2 = validate(obj).missingKeyValue('test4', 10);
		var expected = false;
