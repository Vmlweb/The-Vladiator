(function() {
	...
	Validate.prototype.notSemver = function(){ return this.check(this._notSemver); }
	Validate.prototype._notSemver = function(value){ return !this._isSemver(value); }
	Validate.prototype.isSemver = function(){ return this.check(this._isSemver); }
	Validate.prototype._isSemver = function(value){

		//Perform checks
		return /^([0-9]+)\.([0-9]+)\.([0-9]+)(?:-([0-9A-Za-z-]+(?:\.[0-9A-Za-z-]+)*))?(?:\+[0-9A-Za-z-]+)?$/i.test(value);
	}
